...
const StatsSection = () => {
    return (
        <section className="gradient-bg mt-10 mb-15 md:mb-30">
            <div class="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between text-white py-8 md:py-15 px-6 gap-6 md:gap-0">

                <div class="flex flex-col items-center md:items-start gap-4">
                    <h2 class="text-3xl md:text-6xl font-extrabold">50K+</h2>
                ...
                <div class="flex flex-col items-center md:items-start gap-4">
                    <h2 class="text-3xl md:text-6xl font-extrabold">200+</h2>
